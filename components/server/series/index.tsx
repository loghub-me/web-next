...
export { default as SeriesDetailHeader } from '@/components/server/series/detail/header';
export { default as SeriesDetailContent } from '@/components/server/series/detail/content';
export { default as SeriesDetailAside } from '@/components/server/series/detail/aside';
